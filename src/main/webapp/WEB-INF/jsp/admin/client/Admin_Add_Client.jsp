...
<div class="page-container" style="padding:30px; max-width:800px; margin:0 auto;">
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:24px;">
        ...
        <a href="${pageContext.request.contextPath}/${CLIENT_LIST_URL}" style="padding:9px 18px;background:#f1f5f9;color:#475569;border-radius:8px;text-decoration:none;">
            <c:choose>
                <c:when test="${CLIENT_LIST_URL == 'view_my_clients'}">View My Clients</c:when>
                <c:otherwise>View Clients</c:otherwise>
            </c:choose>
        </a>
    </div>
