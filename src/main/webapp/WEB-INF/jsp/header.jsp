                        ...
                        <%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
                                ...
                                <%-- Back Button Integration: Shows on all pages except the main home dashboard --%>
                                    ...
                                    <a href="${pageContext.request.contextPath}/dashboard" class="gs-header-brand">
                                        <c:if test="${not empty centralConfig.logoPath}">
                                            <c:set var="logoUrl"
                                                value="${fn:startsWith(centralConfig.logoPath, 'http') ? centralConfig.logoPath : pageContext.request.contextPath.concat(centralConfig.logoPath)}" />
                            ...
                            <nav class="gs-nav">
                                <ul class="gs-nav-list">
                                    <%-- Lead Management --%>
                                        <sec:authorize
                                            access="hasAnyRole('SUPERADMIN','ADMIN','LEADS_MANAGE','LEADS_CREATE')">
                                                ...
                                                <ul class="gs-dropdown">
                                                    <sec:authorize
                                                        ...
                                                        <li><a href="${pageContext.request.contextPath}/view_my_leads"
                                                                class="gs-dropdown-item">View My Leads</a></li>
                                                    </sec:authorize>
                                                    <sec:authorize
                                                        access="hasAnyRole('SUPERADMIN','ADMIN','LEADS_MANAGE')">
                                                        <li><a href="${pageContext.request.contextPath}/view_filter_leads"
                                                                class="gs-dropdown-item">All Leads</a></li>
                                                    </sec:authorize>
                                                </ul>
                                            </li>
                                        </sec:authorize>
                                            ...
                                            <sec:authorize access="hasAnyRole('SUPERADMIN','ADMIN','USER_MANAGE')">
                                                <li class="gs-nav-item">
                                                    ...
                                                    <ul class="gs-dropdown">
                                                        ...
                                                        <li><a href="${pageContext.request.contextPath}/admin/users"
                                                                class="gs-dropdown-item">Manage Users</a></li>
                                                    </ul>
                                                </li>
                                            </sec:authorize>
                                                        ...
                                                        <ul class="gs-dropdown">
                                                            <sec:authorize
                                                                ...
                                                                <li><a href="${pageContext.request.contextPath}/view_my_clients"
                                                                        class="gs-dropdown-item">View My Clients</a>
                                                                </li>
                                                            </sec:authorize>
                                                            <sec:authorize
                                                                access="hasAnyRole('SUPERADMIN','ADMIN','CLIENT_MANAGE')">
                                                                <li><a href="${pageContext.request.contextPath}/view_clients_list"
                                                                        class="gs-dropdown-item">All Clients</a></li>
                                                                <li><a href="${pageContext.request.contextPath}/admin/client/sources"
                                                                        class="gs-dropdown-item">Client Source</a></li>
                                                                <li><a href="${pageContext.request.contextPath}/admin/client/types"
                                                                        class="gs-dropdown-item">Client Type</a></li>
                                                            </sec:authorize>
                                                            <sec:authorize access="hasRole('SUPERADMIN')">
                                                                <li><a href="${pageContext.request.contextPath}/city/add"
                                                                        class="gs-dropdown-item">&#127961; Add City</a>
                                                                </li>
                                                            </sec:authorize>
                                                        </ul>
                                                    </li>
                                                    ...
                                                    <%-- Settings --%>
                                                        <li class="gs-nav-item gs-nav-settings">
                                                            <a href="${pageContext.request.contextPath}/settings/profile"
                                                                class="gs-nav-link" title="Settings">&#9881;</a>
                                                        </li>
                                </ul>
                            </nav>