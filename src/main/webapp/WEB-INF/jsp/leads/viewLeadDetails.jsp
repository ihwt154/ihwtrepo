...
<div class="page-container" style="padding:30px; max-width:900px; margin:0 auto;">
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:24px;">
        ...
        <div style="display:flex; gap:10px;">
            <a href="${pageContext.request.contextPath}/view_edit_lead_form?leadId=${LEAD_OBJ.leadId}" style="padding:9px 18px; background:var(--accent-primary); color:#fff; border-radius:8px; text-decoration:none; font-weight:600;">Edit</a>
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px;">
        ...
        <div style="background:rgba(255,255,255,0.85); border-radius:14px; padding:24px; box-shadow:0 2px 12px rgba(0,0,0,0.06);">
            ...
            <table style="width:100%; font-size:0.9rem; border-collapse:collapse;">
                <tr><td style="padding:8px 0; color:#64748b; width:45%;">Lead Title</td><td style="font-weight:600;">${empty LEAD_OBJ.leadTitle ? '—' : LEAD_OBJ.leadTitle}</td></tr>
                <tr><td style="padding:8px 0; color:#64748b;">Lead Name</td><td style="font-weight:600;">${LEAD_OBJ.leadName}</td></tr>
                <tr><td style="padding:8px 0; color:#64748b;">Client</td><td><strong>${LEAD_OBJ.clientName}</strong></td></tr>
                <tr><td style="padding:8px 0; color:#64748b;">Event Name</td><td>${empty LEAD_OBJ.eventName ? '—' : LEAD_OBJ.eventName}</td></tr>
        ...
        <div style="background:rgba(255,255,255,0.85); border-radius:14px; padding:24px; box-shadow:0 2px 12px rgba(0,0,0,0.06);">
            ...
            <table style="width:100%; font-size:0.9rem; border-collapse:collapse;">
                ...
                <tr><td style="padding:8px 0; color:#64748b;">Lead Source</td><td>${empty LEAD_OBJ.leadSource ? '—' : LEAD_OBJ.leadSource}</td></tr>
